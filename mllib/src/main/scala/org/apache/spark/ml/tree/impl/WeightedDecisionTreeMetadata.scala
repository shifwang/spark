 ...
 */
private[spark] class WeightedDecisionTreeMetadata(
    numFeatures: Int,
    numExamples: Long,
...
private[spark] object WeightedDecisionTreeMetadata extends Logging {
  ...
  def buildMetadata(
      ...
      featureWeight: Array[Double]): WeightedDecisionTreeMetadata = {
    ...
    new WeightedDecisionTreeMetadata(numFeatures, numExamples, weightSum, numClasses,
      ...
      numTrees, numFeaturesPerNode, featureWeight)
  }
